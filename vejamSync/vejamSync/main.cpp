...
void setDefaultParameters()
{
	...
	g_appParameters->saveParam(QString("aplicacion"),QString("sync-interval"),QString("60"));
    g_appParameters->saveParam(QString("aplicacion"),QString("webkit-debug"),QString("0"));
    g_appParameters->saveParam(QString("aplicacion"),QString("streamming-mode"),QString("1")); //1: WebKit, 2: MJPEG
    ...
    g_appParameters->saveParam(QString("conexion"),QString("webkit-port"),QString("12345"));
    g_appParameters->saveParam(QString("conexion"),QString("mjpeg-port"),QString("54321"));
